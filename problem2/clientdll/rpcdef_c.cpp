...
handle_t Client_Binding;


static const RPC_CLIENT_INTERFACE IRpcCheck___RpcClientInterface =
    {
...
RPC_IF_HANDLE IRpcCheck_v1_0_c_ifspec = (RPC_IF_HANDLE)& IRpcCheck___RpcClientInterface;

extern const MIDL_STUB_DESC IRpcCheck_StubDesc;

static RPC_BINDING_HANDLE IRpcCheck__MIDL_AutoBindHandle;
    ...
    /* [string][in] */ const wchar_t *pflgstr)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IRpcCheck_StubDesc,
                  (PFORMAT_STRING) &rpcdef__MIDL_ProcFormatString.Format[0],
                  pflgstr);
...
void Shutdown( void)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IRpcCheck_StubDesc,
                  (PFORMAT_STRING) &rpcdef__MIDL_ProcFormatString.Format[38],
                  0);
...
static const MIDL_STUB_DESC IRpcCheck_StubDesc = 
    {
    (void *)& IRpcCheck___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &Client_Binding,
    0,
